...
export default function Biblioteca() {
  return (
    <section id="atendimento" className="py-20 md:py-40 min-h-[90vh] flex flex-col justify-center px-6 lg:px-12 bg-dark border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto text-center relative z-10">
        <motion.div
          ...
          className="max-w-5xl mx-auto py-16 md:py-32 min-h-[80vh] flex flex-col justify-center px-8 lg:px-16 border-2 border-gold/30 bg-gradient-to-br from-[#081848] to-[#13276E] shadow-[0_0_60px_rgba(243,194,26,0.15)] rounded-2xl relative overflow-hidden"
        >
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="inline-flex relative z-10 items-center justify-center bg-gold text-dark px-12 py-5 rounded-full uppercase tracking-widest text-base font-bold shadow-[0_0_30px_rgba(243,194,26,0.4)] hover:bg-gold-hover hover:scale-105 hover:shadow-[0_0_50px_rgba(243,194,26,0.6)] transition-all duration-300 mt-4"
          >
