      ...
      <div className="container mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-1/2">
          ...
          >
            <a
              href="/sobre"
              className="inline-flex items-center text-base uppercase tracking-widest text-light font-medium hover:text-metal transition-colors group"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
            {differentials.map((item, index) => (
              ...
              >
                ...
                <span className="text-light text-base tracking-wide font-normal">{item}</span>
              </motion.div>
            ))}
          </div>
        </div>
