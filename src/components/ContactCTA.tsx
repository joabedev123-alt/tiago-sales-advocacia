    ...
    <section className="py-24 md:py-24 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center max-w-4xl">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-xl md:text-5xl md:text-3xl md:text-5xl lg:text-7xl font-normal text-light tracking-tight mb-8"
        >
        ...
        <motion.p
          ...
          className="text-light-dark font-normal text-xl md:text-2xl leading-relaxed mb-12 max-w-2xl mx-auto"
        >
        ...
        >
          ...
          >
            ...
            <span className="relative text-base font-semibold uppercase tracking-widest flex items-center gap-3">
              Iniciar Atendimento
