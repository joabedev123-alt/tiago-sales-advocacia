...
export default function HomeContact() {
  return (
    <section id="contato" className="py-24 md:py-48 min-h-screen flex flex-col justify-center bg-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-light-beige/90 font-normal text-xl mb-12 max-w-md">
              A complexidade exige respostas exclusivas. Agende uma consultoria preliminar para avaliarmos o seu cenário.
            </p>
            
            <div className="space-y-6 text-base tracking-widest text-light-beige uppercase font-normal">
