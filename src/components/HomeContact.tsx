...
export default function HomeContact() {
  return (
    <section id="contato" className="py-14 md:py-24 bg-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif text-light-beige font-normal leading-tight mb-6 md:mb-8">
              Sua estratégia <br />
              <span className="italic text-brown-sophisticated">começa aqui</span>.
            </h2>
            <p className="text-light-beige/90 font-normal text-base md:text-xl mb-8 md:mb-12 max-w-md">
              A complexidade exige respostas exclusivas. Agende uma consultoria preliminar para avaliarmos o seu cenário.
            </p>
            
            <div className="space-y-6 text-sm md:text-base tracking-wide md:tracking-widest text-light-beige uppercase font-normal">
              ...
              <div className="flex items-center">
                <span className="w-12 h-[1px] bg-gold mr-6"></span>
                <span>adv.tiagosales@gmail.com</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <form className="space-y-8">
              ...
              <button 
                type="submit" 
                className="w-full mt-8 border border-gold bg-gold/5 text-gold py-5 uppercase tracking-widest text-sm font-semibold hover:bg-gold hover:text-dark transition-all duration-300"
              >
                Solicitar Contato
              </button>
            </form>
